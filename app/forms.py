...
class RegistrationForm(Form):
    ...
    confirm = PasswordField('confirmpassword', [Required(), EqualTo('password', message='Passwords must match')])
...
class EntryForm(Form):
    ...
    CourseCode = SelectField('CourseCode', choices=COURSES, validators=[Required()])
    CourseType = SelectField('CourseType', choices=COURSETYPES, validators=[Required()])
    UserInitial = SelectField('UserInitial', choices=INITIALS, validators=[Required()])
...
class MarkingForm(Form):
    CourseCode = SelectField('CourseCode', choices=COURSES, validators=[Required()])
    UserInitial = SelectField('UserInitial', choices=INITIALSTUTOR, validators=[Required()])
    SemesterId = SelectField('SemesterId', choices=SEM, validators=[Required()])
    AssignmentCode = TextField('AssignmentCode')
    AssignmentDue = DateTimeField('AssignmentDue', validators=[validators.optional()])
    MarkingDue = DateTimeField('AssignmentDue', validators=[validators.optional()])
...
class ChangePasswordForm(Form):
    ...
    password = PasswordField('password', [Required()])
    confirm = PasswordField('confirm', [Required(), EqualTo('password', message='Passwords must match')])
